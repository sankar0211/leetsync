...
client.connect().then(() => client.query('UPDATE "DailyProblem" SET date = date + interval \'5 hours 30 minutes\''))
.then(() => client.query('SELECT date FROM "DailyProblem" ORDER BY date ASC'))
